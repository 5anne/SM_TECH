...
const About = () => {
    return (
        <div className='lg:flex items-center gap-8 relative my-24'>
            ...
            <div className='px-4 lg:px-0 mt-14 lg:mt-0'>
                <Image width={120} height={100} alt='Fresh Mushroom' src={leaf} className='absolute top-[5%] left-[70%] lg:left-[35%] w-16 lg:w-32 h-16 lg:h-28'></Image>
